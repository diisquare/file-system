        ...
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('file-manager-index', ['path' => $url['path'], 'view' => 'table']) }}" class="btn btn-default active"><i class="fa fa-list"></i></a>
                        <a href="{{ route('file-manager-index', ['path' => $url['path'], 'view' => 'list']) }}" class="btn btn-default"><i class="fa fa-th"></i></a>
                    </div>
            ...
            <div class="box-footer">
                <ol class="breadcrumb" style="margin-bottom: 10px;">
                    ...
                    <li><a href="{{ route('file-manager-index') }}"><i class="fa fa-th-large"></i> </a></li>
